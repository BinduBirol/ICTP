...
<!--                <div class="floatR r5 gc-full-width">
            ...
            <div class="table-container">
                ...
                <?php if (!$unset_add) { ?>
                        <div class="floatL t5">
                            <a class="btn btn-primary btn-xs" href="<?php echo $add_url ?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject ?></a>
                        </div>
                        <?php } ?>
                    <div class="floatR">
                    <?php if (!$unset_export) { ?>
                            <a class="btn btn-primary btn-xs t5 gc-export" data-url="<?php echo $export_url; ?>">
                            ...
                            <?php } ?>
                            <?php if (!$unset_print) { ?>
                            <a class="btn btn-primary btn-xs t5 gc-print" data-url="<?php echo $print_url; ?>">
                ...
                <table class="table table-bordered grocery-crud-table table-hover">
                    <thead>
                        ...
                        <tr class="filter-row gc-search-row">
                            ...
                            <?php foreach ($columns as $column) { ?>
                                <td>
                                    <input type="text" class="form-control searchable-input input-sm floatL" placeholder="Search <?php echo $column->display_as; ?>" name="<?php echo $column->field_name; ?>" />
                                </td>
                            <?php } ?>
                            ...
                            <td style="border-left: none;" width="100">
                                <div class="floatR">
                                    <a href="javascript:void(0);" title="<?php echo $this->l('list_delete') ?>"
                                       class="hidden btn btn-danger btn-xs delete-selected-button">
                                        <i class="fa fa-trash-o"></i>
                                        <span><b> <?php echo $this->l('list_delete') ?></b></span>
                                    </a>
                                </div>
                                <div class="floatL">
                                    <a href="javascript:void(0);" class="btn btn-primary btn-sm gc-refresh">
                        ...
                        <tr>
                            <td colspan="<?php echo $colspans; ?>">
                                ...
                                <div class="floatR r10 t30">
                                    ...
                                    <?php
                                    echo str_replace(
                                            "{total_results}", "<span class='full-total'>" . $this->get_total_results() . "</span>", $this->l('list_filtered_from'));
                                    ?>
                                    </span>
                                </div>
