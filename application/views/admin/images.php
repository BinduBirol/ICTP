            ...
            <div class="contentpanel">
                ...
                ?>
                    <tr>
                        <td> 
                            <div class="col-md-8">
                                <input id="test<?=$i?>" type="text" value="<?=$assets?>upload/images/<?=$img->name?>" disabled class="form-control"/>
                            </div>
                        ...
                        <td>
                            <img src="<?=$assets?>upload/images/<?=$img->name?>" width="100px"/>
                        </td>
                ...
                <?php } }else{ ?>                                        
                    <tr>
                        <td colspan="3">
                            <div class="col-md-6 alert alert-danger">No Image Found.</div>
                        </td>
                    </tr>
                <?php }?>
                        </tbody>
