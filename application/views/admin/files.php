...
<html lang="en">
    <head>
        ...
        <style>.form-inline .form-control{width: 450px;}</style>
            ...
            <div class="contentpanel">                
                ...
                ?>
                    <tr>
                        <td> 
                            <div class="col-md-8">
                                <input id="test<?=$i?>" type="text" value="<?=$file->file_url?>" disabled class="form-control"/>
                            </div>

                            <div class="col-md-4">
                                <button class="btn btn-primary btn-sm"id="copyButton" onclick="copy('test<?=$i?>')">Copy URL</button>
                                <a href="<?=$file->file_url?>" target="_blank" class="btn btn-primary btn-sm">View File</a>
                            </div>                                                
                        </td>

                        <td><?=$file->created; $i++;?></td>
                    </tr>            

                <?php } }else{ ?>                                        
                    <tr>
                        <td colspan="3">
                            <div class="col-md-6 alert alert-danger">No File Found.</div>
                        </td>
                    </tr>
                <?php }?>
                        </tbody>
